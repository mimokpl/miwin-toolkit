...
export function CreateProject(arg1:devtools.CreateProjectOptions):Promise<devtools.CommandResult>;

export function DevBufGenerate():Promise<devtools.CommandResult>;

export function DevEntGenerate(arg1:string):Promise<devtools.CommandResult>;

export function DevGoModTidy():Promise<devtools.CommandResult>;

export function DevRunService(arg1:string):Promise<devtools.CommandResult>;

export function DevWireGenerate(arg1:string):Promise<devtools.CommandResult>;
...
export function GetDevServices():Promise<Array<devtools.ServiceInfo>>;
