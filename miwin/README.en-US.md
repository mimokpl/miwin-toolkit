...
Miwin CLI (gow) is the core command-line entry of Miwin Toolkit, providing full-lifecycle capabilities such as project scaffolding, microservice management, code generation, and one-click execution, covering the entire process from project creation to development and operation.
...
```shell
go install github.com/mimokpl/miwin-toolkit/miwin/cmd/gow@latest
```
