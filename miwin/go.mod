module github.com/mimokpl/miwin-toolkit/miwin
...
require (
	...
	github.com/mimokpl/go-utils/code_generator v1.1.1
	github.com/mimokpl/go-utils/ddl_parser v1.1.1
	...
	gorm.io/rawsql v1.0.3-0.20250701131124-e260ec7d3588
)
