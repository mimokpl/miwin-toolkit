...
func ServerImportPaths(servers []string) []string {
	...
	for _, server := range servers {
		...
		case "activemq":
			if p := "github.com/mimokpl/kratos-transport/transport/activemq"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "asynq":
			if p := "github.com/mimokpl/kratos-transport/transport/asynq"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "fasthttp":
			if p := "github.com/mimokpl/kratos-transport/transport/fasthttp"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "gin":
			if p := "github.com/mimokpl/kratos-transport/transport/gin"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "gozero":
			if p := "github.com/mimokpl/kratos-transport/transport/gozero"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "graphql":
			if p := "github.com/mimokpl/kratos-transport/transport/graphql"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "hertz":
			if p := "github.com/mimokpl/kratos-transport/transport/hertz"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "iris":
			if p := "github.com/mimokpl/kratos-transport/transport/iris"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "kafka":
			if p := "github.com/mimokpl/kratos-transport/transport/kafka"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "machinery":
			if p := "github.com/mimokpl/kratos-transport/transport/machinery"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "mqtt":
			if p := "github.com/mimokpl/kratos-transport/transport/mqtt"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "nats":
			if p := "github.com/mimokpl/kratos-transport/transport/nats"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "nsq":
			if p := "github.com/mimokpl/kratos-transport/transport/nsq"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "pulsar":
			if p := "github.com/mimokpl/kratos-transport/transport/pulsar"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "rabbitmq":
			if p := "github.com/mimokpl/kratos-transport/transport/rabbitmq"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "redis":
			if p := "github.com/mimokpl/kratos-transport/transport/redis"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "rocketmq":
			if p := "github.com/mimokpl/kratos-transport/transport/rocketmq"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "signalr":
			if p := "github.com/mimokpl/kratos-transport/transport/signalr"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "socketio":
			if p := "github.com/mimokpl/kratos-transport/transport/socketio"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "sse":
			if p := "github.com/mimokpl/kratos-transport/transport/sse"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "tcp":
			if p := "github.com/mimokpl/kratos-transport/transport/tcp"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "thrift":
			if p := "github.com/mimokpl/kratos-transport/transport/thrift"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "trpc":
			if p := "github.com/mimokpl/kratos-transport/transport/trpc"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		case "websocket":
			if p := "github.com/mimokpl/kratos-transport/transport/websocket"; !seen[p] {
				paths = append(paths, p)
				seen[p] = true
			}
		}
