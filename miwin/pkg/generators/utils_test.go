...
func TestServerImportPaths(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: []string{"github.com/mimokpl/kratos-transport/transport/kafka"},
		},
		{
			name:     "mqtt",
			servers:  []string{"mqtt"},
			expected: []string{"github.com/mimokpl/kratos-transport/transport/mqtt"},
		},
		{
			...
			expected: []string{
				"github.com/go-kratos/kratos/v2/transport/grpc",
				"github.com/mimokpl/kratos-transport/transport/kafka",
